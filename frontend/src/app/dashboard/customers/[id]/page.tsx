...
export default function CustomerDetailPage() {
  ...
  const { data: customer, error: customerError, isLoading: customerLoading } = useCustomer(parseInt(customerId))
  const {
    data: transactionsData,
    error: transactionsError,
    isLoading: transactionsLoading,
  } = useTransactions({ customer_id: parseInt(customerId), limit: 5 })
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-foreground">Last purchase: {formatDate(customer.last_purchase_date || customer.created_at)}</span>
                  </div>
                  <div className="flex items-center space-x-2">
