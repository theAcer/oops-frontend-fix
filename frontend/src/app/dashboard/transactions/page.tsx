                ...
                <TableBody>
                  {transactions.map((transaction) => (
                    <TableRow key={transaction.id}>
                      <TableCell className="font-mono text-sm text-foreground">{transaction.mpesa_receipt_number || transaction.id}</TableCell>
                      <TableCell className="text-muted-foreground">{formatDateTime(transaction.transaction_date)}</TableCell>
                      <TableCell className="text-foreground">{transaction.customer_name || transaction.customer_phone}</TableCell>
